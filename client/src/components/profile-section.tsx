...
export default function ProfileSection() {
  ...
  return (
    <section id="profile" className="py-20 bg-gradient-to-br from-[var(--electric-blue)] to-[var(--tech-navy)]">
      <div className="container mx-auto px-6" ref={ref}>
        ...
        >
          <h2 className="font-orbitron text-4xl font-bold mb-4 neon-glow">Professional Profile</h2>
          ...
          >
            <div className="grid lg:grid-cols-3 gap-8 items-center">
              <div className="lg:col-span-1 text-center">
                ...
                >
                  <div className="profile-photo w-64 h-64 mx-auto rounded-full overflow-hidden">
                    <img 
              ...
              <div className="lg:col-span-2">
                <h3 className="text-3xl font-bold text-[var(--matrix-green)] mb-2">{personalInfo.name}</h3>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  >
                    <i className="fas fa-envelope text-[var(--matrix-green)] mr-3"></i>
                    <div>
                  ...
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.02 }}
                  >
                    <i className="fas fa-phone text-[var(--matrix-green)] mr-3"></i>
                    <div>
                  ...
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.02 }}
                  >
                    <i className="fas fa-map-marker-alt text-[var(--matrix-green)] mr-3"></i>
                    <div>
                  ...
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.02 }}
                  >
                    <i className="fab fa-linkedin text-[var(--matrix-green)] mr-3"></i>
                    <div>
